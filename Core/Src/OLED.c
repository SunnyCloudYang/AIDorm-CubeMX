...
uint16_t GPIO_SCL_PIN = GPIO_PIN_8;
uint16_t GPIO_SDA_PIN = GPIO_PIN_9;
...
/**
  ...
  */
void OLED_W_SCL(uint8_t PinState)
{
	/*根据BitValue的值，将SCL置高电平或者低电平*/
	HAL_GPIO_WritePin(GPIOB, GPIO_SCL_PIN, (GPIO_PinState)PinState);
...
/**
  ...
  */
void OLED_W_SDA(uint8_t PinState)
{
	/*根据BitValue的值，将SDA置高电平或者低电平*/
	HAL_GPIO_WritePin(GPIOB, GPIO_SDA_PIN, (GPIO_PinState)PinState);
